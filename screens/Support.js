        ...
        <SafeAreaView style={{ backgroundColor: "white", flex: 1, height: height, display: 'flex', alignItems: 'flex-start' }}>
            ...
            <View style={{ paddingHorizontal: '5%', overflow: 'scroll' }}>
                <View style={{ padding: 15, backgroundColor: '#F8F8F8', marginBottom: 30, borderRadius: 10 }}>
                    ...
                    <Text style={{ marginBottom: 15, color: ColorTheme.grey, fontSize: 14, lineHeight: 18, fontFamily: 'Poppins-Regular' }}>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', alignContent: 'center' }}>
                        ...
                        <Text onPress={() => Linking.openURL("https://wa.me/263773384668")} style={{ color: ColorTheme.main, fontFamily: 'Poppins-SemiBold', display: 'flex', alignContent: 'center', fontSize: 14, }}>
                ...
                <Text style={{ marginBottom: 15, fontSize: 16, lineHeight: 18, fontFamily: 'Poppins-SemiBold', }}>Frequently Asked Questions (FAQs) </Text>
                ...
                >
                    <View>
                        <View style={{ borderColor: ColorTheme.grey2, borderWidth: 2, padding: 10, borderRadius: 10, marginBottom: 10 }}>
                            <Text style={{ marginBottom: 5, color: ColorTheme.grey, fontSize: 13, lineHeight: 20, fontFamily: 'Poppins-SemiBold' }}>How Long does it take to Verify an Address? </Text>
                            <Text style={{ color: ColorTheme.grey, fontSize: 13, lineHeight: 20, fontFamily: 'Poppins-Regular' }}>KYC Africa verifies your address over a period of three consecutive days. If the address location retains a positive result you will get a Verification Successful notification, but if the location fails our verification criteria it will return a Verification Failed result  </Text>
                        </View>
                        <View style={{ borderColor: ColorTheme.grey2, borderWidth: 2, padding: 10, borderRadius: 10, marginBottom: 10 }}>
                            <Text style={{ marginBottom: 5, color: ColorTheme.grey, fontSize: 13, lineHeight: 20, fontFamily: 'Poppins-SemiBold' }}>How do I share my verifcation Certificates? </Text>
                            <Text style={{ color: ColorTheme.grey, fontSize: 13, lineHeight: 20, fontFamily: 'Poppins-Regular' }}>KYC Africa verifies your address over a period of three consecutive days. If the address location retains a positive result you will get a Verification Successful notification, but if the location fails our verification criteria it will return a Verification Failed result  </Text>
                        </View>
                        <View style={{ borderColor: ColorTheme.grey2, borderWidth: 2, padding: 10, borderRadius: 10, marginBottom: 10 }}>
                            <Text style={{ marginBottom: 5, color: ColorTheme.grey, fontSize: 13, lineHeight: 20, fontFamily: 'Poppins-SemiBold' }}>How much data does it take to verify? </Text>
                            <Text style={{ color: ColorTheme.grey, fontSize: 13, lineHeight: 20, fontFamily: 'Poppins-Regular' }}>KYC Africa verifies your address over a period of three consecutive days. If the address location retains a positive result you will get a Verification Successful notification, but if the location fails our verification criteria it will return a Verification Failed result  </Text>
                        </View>
                        <View style={{ borderColor: ColorTheme.grey2, borderWidth: 2, padding: 10, borderRadius: 10, marginBottom: 10 }}>
                            <Text style={{ marginBottom: 5, color: ColorTheme.grey, fontSize: 13, lineHeight: 20, fontFamily: 'Poppins-SemiBold' }}>Who has access to my location data? </Text>
                            <Text style={{ color: ColorTheme.grey, fontSize: 13, lineHeight: 20, fontFamily: 'Poppins-Regular' }}>KYC Africa verifies your address over a period of three consecutive days. If the address location retains a positive result you will get a Verification Successful notification, but if the location fails our verification criteria it will return a Verification Failed result  </Text>
                        </View>
