    ...
    <View style={{ backgroundColor: "white", height: height, display: "flex", alignItems: "center" }}>
      ...
      >
        ...
        <Text style={{ fontFamily: "Poppins-SemiBold" }}>
          you have to be at {title} to add your {title} address.{" "}
        </Text>{" "}
      </Text>
      {!loading ? (
        <Text
    ...
    <View style={{ backgroundColor: "white", display: "flex", alignItems: "center", height: height }}>
      ...
      {hasLocation ? (
        <Text
          style={{
            textAlign: "center",
            backgroundColor: "rgba(47, 191, 0, 0.1)",
            marginBottom: "5%",
        ...
        >
          We have saved your {title} location. Please provide your {title} address details below.{" "}
        </Text>
      ) : null}
...
const GetLocation = () => {
  const { hasLocation, sethasLocation } = useContext(HasLocationContext);
  return <SafeAreaView>{hasLocation ? <GetLocationDetails /> : <GetLocationCords />}</SafeAreaView>;
};
